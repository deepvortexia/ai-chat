...
export const AI_MODELS: Record<string, AIModel> = {
  ...
  "gemini-flash": {
    ...
    inputFormat: "llama",
    tagline: "Fast. Smart. Efficient.",
    description:
      "Google's fastest frontier model — lightning quick responses with strong reasoning.",
    traits: ["Fast responses", "Strong reasoning", "Efficient", "Multimodal"],
